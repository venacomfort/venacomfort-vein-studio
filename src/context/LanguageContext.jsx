...
const translations = {
  en: {
    ...
    sclerotherapyConsentText: 'I hereby consent to undergo cosmetic sclerotherapy. I understand that this is an elective procedure for cosmetic improvement of spider and reticular veins. I have read and initialed each section of the bilingual informed consent regarding procedure, limitations, side effects, and important risks (hyperpigmentation, matting, trapped blood, skin ulceration, clots, and allergies). I have provided an accurate medical history.',
    hipaaConsentText: 'I authorize VenaComfort Vein Studio, LLC to secure my confidential records. I understand that emergency warnings, alternative treatments, compression stocking guidelines, and post-care are integral to my safety and clinical results.',
  ...
  es: {
    ...
    sclerotherapyConsentText: 'Por la presente doy mi consentimiento para someterme a escleroterapia cosmética. Entiendo que es un procedimiento electivo para la mejoría estética de venas de araña y reticulares. He leído y colocado mis iniciales en cada sección del consentimiento informado bilingüe sobre el procedimiento, limitaciones, efectos secundarios y riesgos importantes (hiperpigmentación, matting, sangre atrapada, ulceración, coágulos y alergias). He proporcionado un historial médico correcto.',
    hipaaConsentText: 'Autorizo a VenaComfort Vein Studio, LLC a resguardar mis registros confidenciales. Entiendo que los signos de alarma, tratamientos alternativos, compresión y cuidados posteriores son fundamentales para mi seguridad y resultados clínicos.',
